...
class User extends \Core\Model
{
    ...
    //Get all the posts as an associate array
    ...
    public function validate()
    {
        ...
        if (static::emailExists($this->email, $this->id ?? null)){
            $this->errors[] = 'Podany email już istnieje w bazie';
        }
        ...
        if (isset($this->password)) {
            if (strlen($this->password) < 6){
                $this->errors[] = 'Hasło musi posiadać minimum 6 znaków';
            }

            if (preg_match('/.*[a-z]+.*/i', $this->password) == 0){
                $this->errors[] = 'Hasło musi posiadać pzrynajmniej jedną literę';
            }
